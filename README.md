...
<H2>What's New</H2>
<p>In release 1.9.6</p>
<ul>
<li>Backported setup.py from 1.10</li>
</ul>
...
$ sudo pip install .
```
PIP will automatically resolve the dependencies.

To easily run the installed package without looking up your python path, run
```
$ gerbmerge <args>
```
or
