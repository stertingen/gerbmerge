...
<dd>For Linux, the best option (currently) for viewing Gerber and Excellon files is the [gerbv](http://gerbv.sourceforge.net) program. Simply type in the names of all files generated by GerbMerge as parameters to <tt>gerbv</tt>:
